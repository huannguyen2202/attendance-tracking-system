...
const Banner = () => {
    ...
    return (
        <div className='pt-[8vh] md:pt-[8vh] bg-[#F4F9FF]'>
            <div data-aos="fade-right" className='mx-auto w-[100%] md:w-[90%] lg:w-[75%] mt-8 bg-white md:rounded-[10px] px-3 py-4'>
                <Carousel
                    arrows={true}
                    autoPlay={true}
                    autoPlaySpeed={4000}
                ...
                >
                    {banners.map((banner, index) => (
                        ...
                        >
                            <div className="relative w-full h-[25vh] rounded-[10px] overflow-hidden border border-gray-100 mb-4">
                                <Image
