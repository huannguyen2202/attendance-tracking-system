...
const Offer = () => {
    return (
        <div className='flex items-center justify-center py-18 bg-[#09090B] dark:bg-[#09090B]'>
            <div className='w-[90%] flex lg:w-[75%]'>
                <div>
                    <p className='text-white dark:text-white lg:text-xl'>Fanpage hỗ trợ đối tác 5Sao</p>
                    <iframe
                        className='mt-3'
